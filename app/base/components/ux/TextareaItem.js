/**
 * @fileOverview TextareaItem 多行输入
 */
import React from 'react';
import classNames from 'classnames';
import omit from 'omit.js';
import './TextareaItem.less'
...
class TextareaItem extends React.Component {
    ...
    render(){
        let {
            prefixCls, prefixListCls, style, title, value, defaultValue, clear, editable, disabled, error, className, labelNumber, autoHeight,
        } = this.props;
